...
@$core.Deprecated('Use filesReplyDescriptor instead')
const FilesReply$json = const {
  '1': 'FilesReply',
  '2': const [
...
/// Descriptor for `FilesReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List filesReplyDescriptor = $convert.base64Decode('CgpGaWxlc1JlcGx5EhQKBWZpbGVzGAEgAygJUgVmaWxlcw==');
